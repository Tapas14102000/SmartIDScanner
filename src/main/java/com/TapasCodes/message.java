...
public class message {
	...
	public static String before ="<!DOCTYPE html>\r\n"
			...
			+ "        <div style=\"font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;font-family: sans-serif;\"> SmartIDScanner :";
	public static String middle="</div>\r\n"
			...
			+ "                            <tr>\r\n"
			+ "                                <td style=\"padding: 30px 40px 30px 40px; text-align: center;\"> <span style=\"color:#fff; font-size: 30px\">SmartIDScanner</span> </td>\r\n"
			+ "                            </tr>\r\n"
			+ "                        </table>\r\n"
			+ "                    </td>\r\n"
			+ "                </tr>\r\n"
